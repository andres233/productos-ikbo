    ...
    <>
      <Formik
        ...
        validationSchema={Yup.object().shape({
          firstname: Yup.string().max(255).required('Nombre es obligatorio'),
          lastname: Yup.string().max(255).required('Apellido es obligatorio'),
      ...
      >
        <DialogContent>
          ...
          <DialogContentText id="alert-dialog-description">
            Se ha registrado el usuario correctamente. Ya puedes iniciar sesion.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleRedirectRegister} autoFocus>
            Aceptar
          </Button>
        </DialogActions>
      </Dialog>
